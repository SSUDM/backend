...
public class LoginController {
    ...
    public ResponseEntity<LoginResponse> login(@RequestBody LoginRequest loginRequest) {
        ...
        if (loginUser == null) {
            ...
            LoginResponse loginResponse = new LoginResponse(HttpStatus.BAD_REQUEST, "로그인 Email 또는 설정한 비밀번호가 틀렸습니다.", null,null);
        ...
        LoginResponse loginResponse = new LoginResponse(HttpStatus.OK, "토큰이 정상적으로 발급되었습니다.", jwtToken, loginUser.getUId());
